...
<script type="text/tmpl" id="tmpl">
  <?php echo e(var date = date || new Date(),
      month = date.getMonth(), 
  ...
  <table class="calendar-table table table-condensed table-tight">
          ...
          <table style="white-space: nowrap; width: 100%">
            <tr>
              <td style="text-align: left;">
                ...
                <button class="js-cal-option btn btn-default <?php echo e(: first.toDateInt() <= today.toDateInt() && today.toDateInt() <= last.toDateInt() ? 'active':''); ?>" data-date="<?php echo e(: today.toISOString()); ?>" data-mode="month"><?php echo e(: todayname); ?></button>
              </td>
              <td>
                <span class="btn-group btn-group-lg">
                  <?php echo e(if (mode !== 'day') {); ?>

                    <?php echo e(if (mode === 'month') {); ?><button class="js-cal-option btn btn-link" data-mode="year"><?php echo e(: months[month]); ?></button><?php echo e(}); ?>

                    <?php echo e(if (mode ==='week') {); ?>

                      <button class="btn btn-link disabled"><?php echo e(: shortMonths[first.getMonth()]); ?> <?php echo e(: first.getDate()); ?> - <?php echo e(: shortMonths[last.getMonth()]); ?> <?php echo e(: last.getDate()); ?></button>
                    <?php echo e(}); ?>

                    <button class="js-cal-years btn btn-link"><?php echo e(: year); ?></button> 
                  <?php echo e(} else {); ?>

                    <button class="btn btn-link disabled"><?php echo e(: date.toDateString()); ?></button> 
                  <?php echo e(}); ?>
    ...
    <?php echo e(if (mode ==='year') {
      month = 0;); ?>

    <tbody>
      <?php echo e(for (j = 0; j < 3; j++) {); ?>

      <tr>
        <?php echo e(for (i = 0; i < 4; i++) {); ?>

        <td class="calendar-month month-<?php echo e(:month); ?> js-cal-option" data-date="<?php echo e(: new Date(year, month, 1).toISOString()); ?>" data-mode="month">
          <?php echo e(: months[month]); ?>
    ...
    <?php echo e(if (mode ==='month' || mode ==='week') {); ?>

    <thead>
      <tr class="c-weeks">
        <?php echo e(for (i = 0; i < 7; i++) {); ?>
    ...
    <tbody>
      <?php echo e(for (j = 0; j < 6 && (j < 1 || mode === 'month'); j++) {); ?>

      <tr>
        <?php echo e(for (i = 0; i < 7; i++) {); ?>

        <?php echo e(if (thedate > last) { dayclass = nextmonthcss; } else if (thedate >= first) { dayclass = thismonthcss; }); ?>

        <td class="calendar-day <?php echo e(: dayclass); ?> <?php echo e(: thedate.toDateCssClass()); ?> <?php echo e(: date.toDateCssClass() === thedate.toDateCssClass() ? 'selected':''); ?> <?php echo e(: daycss[i]); ?> js-cal-option" data-date="<?php echo e(: thedate.toISOString()); ?>">
          <div class="date"><?php echo e(: thedate.getDate()); ?></div>
          <?php echo e(thedate.setDate(thedate.getDate() + 1);); ?>
        ...
        <td colspan="7">
          <table class="table table-striped table-condensed table-tight-vert" >
            <thead>
              <tr>
                <th> </th>
                <th style="text-align: center; width: 100%"><?php echo e(: days[date.getDay()]); ?></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <th class="timetitle" >All Day</th>
                <td class="<?php echo e(: date.toDateCssClass()); ?>">  </td>
              </tr>
              <tr>
                <th class="timetitle" >Before 6 AM</th>
                <td class="time-0-0"> </td>
              </tr>
              <?php echo e(for (i = 6; i < 22; i++) {); ?>

              <tr>
                <th class="timetitle" ><?php echo e(: i <= 12 ? i : i - 12); ?> <?php echo e(: i < 12 ? "AM" : "PM"); ?></th>
                <td class="time-<?php echo e(: i); ?>-0"> </td>
              </tr>
              <tr>
                <th class="timetitle" ><?php echo e(: i <= 12 ? i : i - 12); ?>:30 <?php echo e(: i < 12 ? "AM" : "PM"); ?></th>
                <td class="time-<?php echo e(: i); ?>-30"> </td>
              </tr>
              <?php echo e(}); ?>
...
</script> ?><?php /**PATH D:\xampp\htdocs\dazohb\resources\views/calendar.blade.php ENDPATH**/ ?>