        ...
        <div class="row">
            <div class="col-12">
                <table id="tblownerhorse" class="table-season-details table-bordered">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $data['ownerHorse']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo e(url('trainerdetails', $id = $result->h_t_id)); ?>">
                                        <?php echo e($result->t_name); ?>
...
</div><?php /**PATH /home/n5v1kkfmopdy/public_html/dazohb/resources/views/sections/owner-horse.blade.php ENDPATH**/ ?>