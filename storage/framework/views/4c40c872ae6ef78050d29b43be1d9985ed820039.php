					...
					<div class="row row-package-header">
						<div class="col-12">
							...
							<div class="row row-header2">
								<div class="col-12">
								<img src="images/DazoCoin-png.png"><span>300</span>
								</div>
				...
				<div class="col-sm-6 col-lg-6 col-md-6 col-12 yearly-block">
					<div class="row row-package-header">
						<div class="col-12">						
							...
							<div class="row row-header2">
								<div class="col-12">
									<img src="images/DazoCoin-png.png"><span>1000</span>
								</div>
							</div>
						</div>
					</div>
...
<?php /**PATH D:\xampp\htdocs\dazobh\resources\views/sections/subscribe-section.blade.php ENDPATH**/ ?>