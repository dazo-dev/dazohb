<div class="row subscribe-row">
	...
	<div class="col-sm-6 col-lg-6 col-12 daily-block <?php echo e(($stat == 'subscription' ? 'subscription' : '')); ?>">
			...
			<div class="row">
				<div class="col-12">
					<div class="daily-button">
						<button>
							<a href="">
								SUBSCRIBE FOR ONLY <img src="<?php echo e(url('/')); ?>/images/DazoCoin-png.png"> 20
							</a>
						</button>
					</div>
				</div>
	...
	<?php else: ?>
		...
		<div class="col-sm-6 col-lg-6 col-12 pro-block">
					...
					<div class="row row-package-header">
						<div class="col-12">
							...
							<div class="row row-header2">
								<div class="col-12">
								<img src="<?php echo e(url('/')); ?>/images/DazoCoin-png.png"><span>300</span>
								</div>
				...
				<div class="col-sm-6 col-lg-6 col-md-6 col-12 yearly-block">
					<div class="row row-package-header">
						<div class="col-12">						
							...
							<div class="row row-header2">
								<div class="col-12">
									<img src="<?php echo e(url('/')); ?>/images/DazoCoin-png.png"><span>1000</span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="monthy-year-button">
				<button>
					<a href="<?php echo e(route('subscription')); ?>">LEARN MORE</a>
				</button>
			</div>
		</div>
	<?php endif; ?>
</div>
<?php /**PATH /home/n5v1kkfmopdy/public_html/dazohb/resources/views/sections/subscribe-section.blade.php ENDPATH**/ ?>