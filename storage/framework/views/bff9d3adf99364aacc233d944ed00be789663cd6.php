  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="margin-bottom: 5%;">
        <form method="POST" action="<?php echo e(route('verify')); ?>" id="verifyOTP">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\Users\Paul Jovit Calibuso\code\dazohb2\resources\views/modals/otp.blade.php ENDPATH**/ ?>