...
<body>
    <div class="overlay-main" style="background-color: #2d2121ad;height: 100vh;width: 100%;z-index: 1000000;position: fixed;top: 0;display: none">
        <img src="https://media.tenor.com/images/20039a1a39b050b8518d4d0bdcd35ba6/tenor.gif" style="width: 10%; position: fixed; top: 50%; left: 41%;">
    </div>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-fixed-top shadow-sm">
            <div class="container full-width">
                <a class="navbar-brand" href="<?php echo e(url('/home')); ?>">
                    ...
                    <img src="../public/images/logodazo2.png">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto link-area">
                        ...
                        <a href="#" class="nav-item nav-link">RACES</a>
                        <li></li>
                        <li class="dropdown">
                            <a href="<?php echo e(route('horses')); ?>" class="nav-item nav-link dropbtn">HORSES</a>
                    ...
                    <ul class="navbar-nav ml-auto profile">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="background-color: #000;">
                                <a class="dropdown-item" href="javascript:void(0)">Hi! <?php echo e(Auth::user()->name); ?>

                                    <br>
                                    <p><?php echo e((Auth::user()->is_subscribed == 1) ?  Auth::user()->subscription_type : 'No Subscription'); ?></p>
                                </a>
                                <a class="dropdown-item" href="javascript:void(0)">
                                    <img src="images/DazoCoin-png.png" width="40px" style="float: left; margin-right: 15px;">
                                    <div>
                                        <div class="col-sm-6">
...
<?php /**PATH D:\xampp\htdocs\dazobh\resources\views/layouts/app.blade.php ENDPATH**/ ?>