...
<div class="container">
    ...
    <div class="bg-black content-white user-top-section">
    	<?php echo $__env->make('sections.pro-package', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="content-white contact-section">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n5v1kkfmopdy/public_html/dazohb/resources/views/subscription.blade.php ENDPATH**/ ?>