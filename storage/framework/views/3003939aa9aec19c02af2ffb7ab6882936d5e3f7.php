...
<div class="container">
    ...
    <div class="bg-black content-white user-top-section" style="background:url('') !important;background-color: #0f1010 !important">
        ...
        <?php echo $__env->make('sections.horse-list-section', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n5v1kkfmopdy/public_html/dazohb/resources/views/horses.blade.php ENDPATH**/ ?>