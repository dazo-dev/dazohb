    ...
    <div class="main-container">
        <div class="col-sm-12 row-header d-inline-flex p-0">
            <div class="col-lg-6 col-sm-12 p-0">
                ...
                ?>
                <?php if( date("Y-m-d") == date("Y-m-d",strtotime(str_replace('-','/', $a))) ): ?>
                                ...
                                <?php if($data['resCount'] > 0): ?>
                                    ...
                                    <td>
                                        <button class="btn-r-res btn-date-switch" style="width: 100% !important">
                                            <h5><?php echo e($data['slug'] != null ? date('F d, Y',(strtotime ( $data['slug'] ) )) : date('F d, Y',(strtotime ( date('Y-m-d') ) ))); ?></h5>
                                            <?php
                                                $a = substr("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]", strrpos("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]", '/') + 1);
                                            ?>
                                            <?php if( ctype_alpha($a) ): ?>
                                                <p>RACE RESULT</p>
                                            
                                            <?php elseif( date("Y-m-d") >= date("Y-m-d",strtotime(str_replace('-','/', $a))) ): ?>
                                                <p>RACE RESULT</p>
                                ...
                                <?php if($data['ractiveCount'] > 0): ?>
                                    <td>
                                        <button class="active btn-r-cur btn-date-switch" target-section="previous-accordion" style="width: 100% !important">
                                            <h5>
                                            <?php echo e($data['slug'] != null ? date('F d, Y',(strtotime ( $data['slug'] ) )) : date('F d, Y',(strtotime ( date('Y-m-d') ) ))); ?>
        ...
        <div class="col-sm-12 row-header d-inline-flex" style="background-color: #171717; width: 100%; height: 15vh; margin-top: 1%; padding: 20px 35px;">
            <div class="col-lg-4 col-sm-12 p-0">
                <img src="<?php echo e(url('/')); ?>/images/DazoCoin-png.png" style="float: left;">
        ...
        <?php if($data['ractiveCount'] > 0): ?>
            <div class="col-sm-12 race-main-table accord-sect row-race-accordion hidden-r-program" style="margin-top: 1% !important;">
                <?php
                    $a = substr("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]", strrpos("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]", '/') + 1);
                ?>
                <?php if( date("Y-m-d") == date("Y-m-d",strtotime(str_replace('-','/', $a))) || ctype_alpha($a) ): ?>
                ...
                <div class="sect-cur">
                    <?php $__empty_2 = true; $__currentLoopData = $data['curDResults']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                        <?php if($result->r_status == 1): ?>
                            <button class="accordion frp-sect hid-btn-cur display-flex display-block-mb" target-race="<?php echo e($result->id); ?>" target-date="<?php echo e($result->r_date); ?>">
                            <div>    
                        ...
                        <?php else: ?>
                            <button class="accordion frp-sect-result hid-btn display-flex display-block-mb" target-race="<?php echo e($result->id); ?>" target-date="<?php echo e($result->r_date); ?>" style="display: none">
                                <div>
                                <span class="fas fa-angle-right"></span>
                                <span class="race-num">&nbsp RACE <?php echo e($result->r_num); ?></span>
                                </div>
                            ...
                            <div class="panel hid-panel">
                                ...
                                <!-- <div class="row bet-row col-five" style="padding: 0px 25px;"> -->
                                    ...
                                    <?php if($result->r_replay != ""): ?>
                                        <a href="<?php echo e($result->r_replay); ?>" target="_blank">View Replay</a>
                                    <?php else: ?>
        ...
        <?php else: ?>
            <div class="col-sm-12 race-main-table accord-sect row-race-accordion" style="margin-top: 1% !important;">
                <?php $__empty_2 = true; $__currentLoopData = $data['yesDResults']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                    <button class="accordion frp-sect-result display-flex display-block-mb" target-race="<?php echo e($result->id); ?>" target-date="<?php echo e($result->r_date); ?>">
                        <div>
                            <span class="fas fa-angle-right"></span>
                            <span class="race-num">&nbsp RACE <?php echo e($result->r_num); ?></span>
                        </div>
...
</div><?php /**PATH /home/n5v1kkfmopdy/public_html/dazohb/resources/views/sections/full-race-prog-n-section.blade.php ENDPATH**/ ?>