...
<div class="container">
                      ...
                      <form>
                        ...
                        <div class="row" style="display:block;">
                          <div class="col-lg-12 col-sm-12">
                            ...
                            {{-- <form id="dotrans" action="{{ url('/dotransaction') }}" method="post">
                              @csrf --}}
                              <label for="fname"><i class="fa fa-user"></i> Transaction Id</label>
                              <input type="text" id="transId" name="transactionId" value="{{ $data['transId'] }}">
                              <label for="email"><i class="fa fa-envelope"></i> Email</label>
                              <input type="text" id="email" name="email" value="{{ isset($data['authEmail']) ? $data['authEmail'] : '' }}">
                              <label for="adr"><i class="fa fa-address-card-o"></i> Amount</label>
                              <input type="text" id="transamount" name="transamount" placeholder="0.00" value="{{ $data['transAmount'] }}">
                              <label for="city"><i class="fa fa-institution"></i> Description</label>
                              <input type="text" id="transDetails" name="transdetails" placeholder="Details" value="{{ $data['transacrDetails'] }}">
                            {{-- </form> --}}
                            {{-- <div class="row">
                              <div class="col-50">
 ...
 --}}                                <a href="https://test.dragonpay.ph/GenPay.aspx?merchantid=SAMPLEGEN&invoiceno={{ $data['transId'] }}&name={{ $data['authUser'] }}&email={{ $data['linkEmail'] }}&amount={{ $data['transAmount'] }}&remarks={{ $data['linkDescription'] }}">
                                  <i>
...
{{--                             <label for="cname">Name on Card</label>
                  ...
                  <div class="col-lg-5 col-sm-12">
                    <div class="container" style="margin-top: 9.5%;">
                      ...
                      <p><a href="#">{{ $data['transType'] }}</a> <span class="price">{{ $data['transAmount'] }}</span></p>
                      <hr>
                      <p>Total <span class="price" style="color:#fff"><b>₱{{ $data['transAmount'] }}</b></span></p>
                    </div>
                  </div>
                </div>
            </div>
