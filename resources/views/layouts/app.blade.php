                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="background-color: #000;">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)">
                                    <img src="{{url('/')}}/images/DazoCoin-png.png" width="40px" style="float: left; margin-right: 15px;">
                                    <div>
                                        <div class="col-sm-6">
                                ...
                                <a class="dropdown-item" href="{{ route('profile') }}" style="border-top: 1px solid gray;">
                                    My Account
                                </a>
