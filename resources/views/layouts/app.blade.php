            ...
            <div class="container full-width">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <a href="#" class="nav-item nav-link">OTB LOCATOR</a>
            ...
            <div class="container full-width">
                ...
                <a class="navbar-brand" href="{{ url('/home') }}">
                    ...
                    {{--@if (Route::current()->getName() == 'checkout')
                        ...
                        <img src="../images/logodazo2.png">

                    @elseif(Route::current()->getName() == 'jockeydetails' || Route::current()->getName() == 'horsedetails')
                    ...
                    <img src="{{url('/')}}/images/logodazo2.png">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto link-area">
                        ...
                        <a href="{{ url('/otb') }}" class="nav-item nav-link" onclick="$('.map-section').focus()">OTB LOCATOR</a>

                        <a href="#" class="nav-item nav-link">LIVESTREAM</a>

                        <a href="#" class="nav-item nav-link">BET</a>

                        <a href="{{ url('/home') }}" class="nav-item nav-link">RACES</a>
                        ...
                        <a id="_selpage-selected" href="#" class="nav-item nav-link dropbtn">
                           ...
                           @if (Route::current()->getName() == 'horses') HORSES

                           @elseif (Route::current()->getName() == 'jockey') JOCKEYS

                           @elseif (Route::current()->getName() == 'trainer') TRAINERS

                           @elseif (Route::current()->getName() == 'owner') OWNERS
                         ...
                         <div class="dropdown-content">
                           ...
                           <a id='_selpage' href="{{ route('horses') }}">HORSES</a>

                           <a id='_selpage' href="{{ route('trainer') }}">TRAINERS</a>

                           <a id='_selpage' href="{{ route('owner') }}">OWNERS</a>

                           <a id='_selpage' href="{{ route('jockey') }}">JOCKEYS</a>
                    ...
                    <ul class="navbar-nav ml-auto profile">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="background-color: #000;">
                                ...
                                <a class="dropdown-item active-user-current" target-active-id="{{ Auth::user()->id }}" href="javascript:void(0)">Hi,&nbsp;{{ Auth::user()->name }}

                                    <br>

                                    <p class="subscription-level" target-sub="{{ Auth::user()->is_subscribed }}">{{ (Auth::user()->is_subscribed == 1) ?  Auth::user()->subscription_type : 'No Subscription' }}</p>

                                </a>

                                <a class="dropdown-item dazo-coin" href="javascript:void(0)">

                                    <div class="d-flex">

                                        <img src="{{url('/')}}/images/DazoCoin-png.png" width="40px">

                                        <div>

                                            <p style="margin: 0">Dazo Coin</p>

                                            <h4 style="font-size: 14px">{{ (Auth::user()->coins == "") ? 0 : Auth::user()->coins }}</h4> 

                                        </div>

                                    </div>

                                    <button class="btn">+ BUY DAZO COINS</button>

                                </a>

                                <a class="dropdown-item my-account with-divider" href="{{ route('profile') }}">

                                    My Account

                                </a>

                                <a class="dropdown-item invite-friends" href="javascript:void(0)" data-toggle="modal" data-target="#referModal">

                                    Invite Friends

                                </a>

                                <a class="dropdown-item settings mb-1" href="javascript:void(0)">

                                    Settings

                                </a>

                                <a class="dropdown-item logout with-divider" href="{{ route('logout') }}"
