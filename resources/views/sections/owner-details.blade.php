...
@php
    ...
    @endphp
    <div class="col-sm-12">
        @foreach ($data['ownerDetails'] as $result)
            <div class="row">
                <div class="col-sm-5 p-b-1 p-t-1">
                    <img class="img-horsedetails" src='//localhost/dazoAdmin/public/uploads/owner-img/{{ $result->o_img_path }}' alt="" style="width:100% !important;height:100% !important;">
                </div>
                <div class="col-sm-7">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="horsename">{{ $result->o_name }}</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <table class="table-horseprofile w-100-mb" style="font-size: 13px;">
                                <tr>
                                    <td><p>Sex:</p></td>
                                    <td><p>{{ ($result->o_sex == 'M' ? 'Male' : 'Female') }}</p></td>
                                </tr>
                                <tr>
                                    <td><p>Age:</p></td>
                                    <td><p>{{ $result->o_age }}</p></td>
                                </tr>
                                <tr>
                                    <td><p>Nationality:</p></td>
                                    <td><p>{{ $result->o_nation }}</p></td>
                                </tr>
                                <tr>
                                    <td><p>Background:</p></td>
                                    <td><p>{{ $result->o_bground }}</p></td>
                                </tr>
                            </table>
                        </div>
