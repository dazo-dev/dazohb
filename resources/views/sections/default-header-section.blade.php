    ...
    <div class="container full-width">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto btn-area">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-login" data-toggle="modal" data-target="#signinModal" href="javascript:void(0)">{{ __('Log in') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-register" data-toggle="modal" data-target="#registerModal" href="javascript:void(0)">{{ __('Sign Up') }}</a>
                </li>
            </ul>
        </div>
    </div>
