			...
			<div class="col-md-6">
				<div class="row balance-container" style="background-color:#000;">
					...
					<div class="col-md-5 balance-col">
						...
						<div class="row balance"><p>{{ (Auth::user()->coins == "") ? 0 : Auth::user()->coins }}</p></div>
					</div>
			...
			<div class="col-md-6 col-buy-coin">
				<div class="row row-dazo-coin-price">
					...
					<div class="col-md-4 col-dazo-btn">
						<button><a href="{{url('checkout', [$type = 'coin', $amount = '100'])}}" style="color: #fff;text-decoration: none">BUY DAZO COINS</a> </button>
					</div>
				</div>
				<div class="row row-dazo-coin-price">
					<div class="col-md-3 col-price">
					...
					<div class="col-md-4 col-dazo-btn">
						<button><a href="{{url('checkout', [$type = 'coin', $amount = '500'])}}" style="color: #fff;text-decoration: none">BUY DAZO COINS</a> </button>
					</div>
				</div>
				<div class="row row-dazo-coin-price">
					<div class="col-md-3 col-price">
					...
					<div class="col-md-4 col-dazo-btn">
						<button class="fin"><a href="{{url('checkout', [$type = 'coin', $amount = '1000'])}}" style="color: #fff;text-decoration: none">BUY DAZO COINS</a> </button>
					</div>
				</div>
			</div>
		</div>
