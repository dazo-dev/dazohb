<div id="calenderCarouselIndicator" class="carousel slide" data-ride="carousel" style="margin-top: 2%">
    ...
    <div class="carousel-item active">
      <div class="row">
        ...
        <div class="col-lg-6 col-xl-6 col-12">
          <img src="images/calendar.png" alt="First slide">
        </div>
      </div>
    </div>
  </div>

  <a class="carousel-control-prev" href="#calenderCarouselIndicator" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#calenderCarouselIndicator" role="button" data-slide="next">
