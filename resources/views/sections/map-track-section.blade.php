<div class="map-section">
	<div class="row">
		<div class="col-lg-6 col-xl-6 col-12 left-block" id="mapselection">
			<div class="header">Off-Track Betting Locator</div>
			...
			<div id="mapAddress" class="block-layer-result">
		...
		<div class="col-lg-6 col-xl-6 col-12 right-block p-0">
