      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        <tr>
          <td style="color: #ffff; font-family: Arial, sans-serif;">
            <h1 style="font-size: 24px; margin: 0;">Dazo Email Change Verification</h1>
          </td>
        </tr>
        <tr>
          <td style="color: #ffff; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
            <p style="margin: 0;">
              Hi! {{ Auth::user()->name }},
              <br><br>
              If you did not do this action, please ignore this message. 
              <br>
              To complete the process of changing your email to {{ $str }} please click the Link below. 
            </p>
            <br>
            
              
            <a href="{{ url('/') }}/verifyemailchange/{{ $details['encEmail'] }}/{{ $details['encToken'] }}">CLICK ME!</a>
          </td>
        </tr>
      </table>
    </td>
